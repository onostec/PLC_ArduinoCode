...
void setup() {
  ...
  lcd.setCursor(0,0);              //display "ANALOG: " at column 0, row 0 of the LCD
  lcd.print("ANALOG: ");
  lcd.setCursor(0,1);              //display "LAMP: " at column 0, row 1 of the LCD
  lcd.print("LAMP: ");
...
void loop() {
  ...
  input();
    ...
    I1 = map(A_1, 0, 1023, 0, 99);
    lcd.setCursor(8,0);              //display the value of I1 at column 8, row 0 of the LCD
    lcd.print(I1);
    
    if (I1 >= 30 && I1 <= 80) {
      R1 = 1;
      lcd.setCursor(6,1);              //display ON at column 6, row 1 of the LCD
      lcd.print("ON ");
    } else {
      R1 = 0;
      lcd.setCursor(6,1);              //display ON at column 6, row 1 of the LCD
